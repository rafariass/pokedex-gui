...
const NotFound = () => {
  ...
  return (
    <PokeDashboard>
      <PokeHeader />
      <PokeMain className='flex-col gap-8 md:w-1/2 px-4'>
        ...
        <button onClick={() => navigate(-1)} className='bg-[#ed5564] hover:bg-[#d64d5a] text-white py-3 px-12 rounded-full transition-transform duration-300 hover:scale-105 shadow-lg flex items-center justify-center gap-3 cursor-pointer'>
